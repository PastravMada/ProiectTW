...
<body>
	...
	<section id="insertFloare" >
		<!-- <div style="padding-left:52px;padding-right:52px;align=center;"><h3 style="background-color:#BDB76B;color:black;padding-left:290px;">Insereaza floare</h3></div> -->
				...
				<form  action="inserting.php" align="center" method="POST" autocomplete="on" enctype="multipart/form-data" id="wrapper"  class="animate form">
						...
						<button class="signin button" type="submit" name="submit" value="ADAUGA FLOARE"/>ADAUGA FLOARE</button>
