...
pentru florile sale colorate divers.Aceasta planta ne va atrage privirile datorita faptului ca are doar o tija cu boboc, sau cu floare,
 si nicio frunza. Uneori nici tija nu i se vede foarte bine, ci doar mugurul carnos al florii care iese din pamant. ');
...
INSERT INTO PLANTE(id_planta,id_detalii,denumirePopulara,denumireStiintifica,imagine,descriere) 
VALUES(108,8,'Panselute','Viola tricolor','Imagini/panselute.jpg','Panseluta este o floare de origine europeana, care creste în toate anotimpurile. A fost introdusa in America de Nord, unde s-a raspandit pe vaste teritorii si este cunoscuta ca Johnny Jump Up (desi numele este folosit pentru a 
denumi si alte specii similare precum Panseaua galbena). Shakespeare face o referire mai directa la Panseluta in Visul unei nopti de vara. Oberon il trimite
 ...
 Cupidon, destinata unei "vestale drepte, incoronata de vestici" (se presupune ca este vorba de Regina Elisabeta I) pentru a cadea peste planta 
...
INSERT INTO PLANTE(id_planta,id_detalii,denumirePopulara,denumireStiintifica,imagine,descriere) 
VALUES(127,27,'Ciclama','Cyclamen persicum','Imagini/ciclama.jpg','Createre compacta, flori frumoase rasfrante spre spate, pe tulpini lungi si frunze decorative cu desene argintii ai verzi.Florile au culori stralucitoare sau nuante pastel, sunt mari si frapante sau mici si parfumate.');
...
INSERT INTO PLANTE(id_planta,id_detalii,denumirePopulara,denumireStiintifica,imagine,descriere) 
VALUES(129,29,'Papadie','Taraxacum officinale','Imagini/papadia.jpg','Papadia este o planta erbacee din familia compozitelor, cu frunze lungi, crestate si cu flori galbene grupate in capitule. Mai este numita si buha, cicoare, crestatea, laptuca, lilicea, mata, papalunga, pilug, turci, floarea-broastei, floarea-gsinii, floarea-mslaiului, floarea-sorului, floarea-turcului, flori-galbene, galbinele-grase, gusa-gainii, ouale-gainilor, papa-gainii, parasita-gainilor sau pui-de-gasca.');
...
INSERT INTO PLANTE(id_planta,id_detalii,denumirePopulara,denumireStiintifica,imagine,descriere) 
VALUES(135,35,'Frezie','Freesia','Imagini/frezia.jpg','Plante delicate și parfumate, freziile sunt folosite în diverse aranjamente florale, singure, în asociere cu frunze proprii, in asociere cu Asparagus sau combinate cu alte specii de flori sau ramuri inflorite.');
