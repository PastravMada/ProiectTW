...
'Mirosul puternic si placut, folosit in produsele cosmetice.','oricare','februarie-martie','trandafir','rosu','intre 20 si 30','vara','The strong smell and pleasant, used in cosmetics. ','La forte odeur et agreable, utilise dans les cosmetiques.');
...
'Mirosul puternic si placut, folosit in produsele cosmetice.','oricare','februarie-martie','trandafir','albastru','intre 20 si 30','vara','The strong smell and pleasant, used in cosmetics. ','La forte odeur et agreable, utilise dans les cosmetiques.');
...
'Proprietati terapeutice.','nisipos','februarie-martie','','albastru','intre 5 si 9','iarna','Therapeutic properties.','Proprietes therapeutiques.');
...
INSERT INTO DETALII(id_detalii,origine,localizare,caracteristici,inmultire,imagini,beneficii,regimDezvoltare,perioadaCultivare,
soiuriInrudite,culoare,temperatura,anotimp,descriereEngleza,descriereFranceza) VALUES(31,'Asia','munte','Prefera un sol bine drenat, in locuri insorite sau la umbra copacilor si arbustilor.','bulbi','Imagini/brandusa.jpg',
